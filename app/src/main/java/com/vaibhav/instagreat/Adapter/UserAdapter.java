...
import com.vaibhav.instagreat.MainActivity2;
...
public class UserAdapter extends RecyclerView.Adapter<UserAdapter.ViewHolder>{
    ...
    private final Boolean isFragment; // bcz we have planned to use this UserAdapter in fragment as well as in activities.
                                // there may be a slight change in code.. that's why
    ...
    private void isFollowed(final String id, final Button btnFollow) {
        ...
        // this will check whether the user is being followed by the current user :
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.child(id).exists()) {
                    ...
                    btnFollow.setBackgroundResource(R.drawable.following_button_background);
                } else {
